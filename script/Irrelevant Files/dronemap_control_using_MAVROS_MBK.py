...
#The purpose of this code is to set the 03 different modes of the Quadcopter
# sequentially i.e. GUIDED, ARM and TAKEOFF
...
def menu():
    ...
    print "8: MBK Special Mode (ALl together) i.e. GUIDED, ARM and TAKEOFF"
